...
const positiveMessages = [
  ...
  "🌬️ Respire fundo e siga com confiança!",
  ...
  "❤️ Espalhe gentileza e receba em dobro!",
  ...
  "☀️ Hoje é um ótimo dia para ser feliz!",
  ...
  "🛤️ O futuro é construído com suas escolhas!",
  ...
  "🛠️ Construa a vida dos seus sonhos!",
  "🛤️ Seu caminho está cheio de possibilidades!",
  "🍰 Pequenos prazeres tornam o dia melhor!",
  "📍 Você está exatamente onde precisa estar!",
  "🎓 Aprenda algo novo e expanda horizontes!",
  "🗺️ Explore novos caminhos e oportunidades!",
  "🕶️ Encare desafios com estilo!",
  ...
  "🏖️ Tire um momento para relaxar e recarregar!",
